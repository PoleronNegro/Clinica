...
SECRET_KEY = '!56^1a&a-_#!^(1fc!gd98i&!hob%x6t@c#d+38zi^qna%4w3v'
...
#Parametrosde la abse de datos dadas por matias general
DATABASES = {
    'default': {
        ...
        'USER': 'root',
        'PASSWORD': '',
        'HOST': '127.0.0.1', # cambiar despues por 127.0.0.1
        'PORT': '3306',
    }
}
